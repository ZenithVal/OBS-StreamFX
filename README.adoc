...
|link:https://github.com/ajunlonglive/MAXINE-AFX-SDK[NVIDIA Maxine Audio Effects SDK]
|link:https://github.com/ajunlonglive/MAXINE-AFX-SDK/blob/master/LICENSE[MIT License]
